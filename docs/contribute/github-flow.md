<!-- Space: Projects -->
<!-- Parent: ZshHacker -->
<!-- Title: Contributing GithubFlow ZshHacker -->
<!-- Label: ZshHacker -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-hacker project on [GitHub](https://github.com/hadenlabs/zsh-hacker), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-hacker/pulls).
...
To follow the instructions in this guide and start contributing to zsh-hacker project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-hacker.git
```

Now your **upstream** points to **hadenlabs/zsh-hacker**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-hacker
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-hacker/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
